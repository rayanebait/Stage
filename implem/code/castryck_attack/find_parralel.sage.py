...
# This file was *autogenerated* from the file find_parralel.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_6 = Integer(6)
...
E1, xs = ec.chain_3radials(E0, [P0.xy()[_sage_const_0 ], Q0.xy()[_sage_const_0 ], PQ0.xy()[_sage_const_0 ]],zeta3, _sage_const_2 *e3)
t4 = time()
...
x4 = xs[_sage_const_0 ]
for _ in range((_sage_const_3 *e2)-_sage_const_2 ):
    x4 = ec.x_onlyDoubling(E1, x4)
E1_, xs = ec.WeierstrassToMontgomery(E1, x4, xs, x_only=True)
Pd = E1_.lift_x(xs[_sage_const_0 ])
Qd = E1_.lift_x(xs[_sage_const_1 ])
if not (Pd + Qd).xy()[_sage_const_0 ] == xs[_sage_const_2 ]:
    Qd = -Qd
...
f = R([_sage_const_0 , a[_sage_const_3 ], a[_sage_const_1 ], _sage_const_1 ])
alpha = f.roots()[_sage_const_1 ][_sage_const_0 ]
alpha1 = alpha[_sage_const_1 ]
alpha0 = alpha[_sage_const_0 ]

assert alpha == Fp2d(alpha0 + Fp2d.gen()*alpha1)

f1 = R([-_sage_const_1 , _sage_const_2 *alpha0/alpha1, _sage_const_1 ])
f2 = R([-_sage_const_1 ,-_sage_const_2 *alpha0/alpha1, _sage_const_1 ])
f3 = R([-_sage_const_1 ,-_sage_const_2 *(alpha0*(alpha0**_sage_const_2 +alpha1**_sage_const_2 -_sage_const_1 ))/(alpha1*(alpha0**_sage_const_2 +alpha1**_sage_const_2 +_sage_const_1 )), _sage_const_1 ])
...
rs = [r[_sage_const_0 ] for r in g.roots()]

assert len(rs) == _sage_const_6 
isogeneous_prods = []
                    ...
                    for r4 in rs:
                        if r4 not in [r1,r2,r3]:
                            ...
                            try:
                                ...
                                isogeneous_prods.append(                                                        E_.j_invariant()                                                         )
                                isogeneous_prods.append(                                                        E.j_invariant(),                                                         )
                            except:
                                print(".", end ='')
